// Comprueba que los tests cargados de Administración reproducen exactamente el
...
//
// Uso: node scripts/verify-administracion-quizzes.mjs
...
import {
  ...
  collectQuestions,
  readWorkbook,
} from './import-administracion-quizzes.mjs'
...
if (mine.length !== 12) {
  problems.push(`Se esperaban 12 evaluaciones y hay ${mine.length}`)
}
